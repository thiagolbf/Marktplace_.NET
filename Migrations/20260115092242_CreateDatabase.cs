        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vendedores_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EnderecoValor_Rua = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    EnderecoValor_Numero = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: true),
                    EnderecoValor_Bairro = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    EnderecoValor_Cidade = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    EnderecoValor_Estado = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnderecoValor_Cep = table.Column<string>(type: "varchar(9)", maxLength: 9, nullable: true),
                    CriadoEm = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AtualizadoEm = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransacaoId = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false),
                    CriadoEm = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AtualizadoEm = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Avaliacoes_ClienteId_ProdutoId",
                table: "Avaliacoes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vendedores_ApplicationUserId",
                table: "Vendedores",
                column: "ApplicationUserId",
                unique: true,
                filter: "[ApplicationUserId] IS NOT NULL");
